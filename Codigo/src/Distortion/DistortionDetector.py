...
def Validation(
    ...
    # después de recalcular k_medida


    # Se calculan errores del ajuste
    # RMSE
    y_ajuste_final = x_filtrado * k_medida
    residuos_final = y_ajuste_final - y_filtrado
    RMSE = np.sqrt(np.mean(residuos_final**2)) #px
